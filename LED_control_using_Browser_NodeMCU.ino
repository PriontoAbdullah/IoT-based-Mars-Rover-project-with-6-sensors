...
const char* ssid = "friends hub"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "agetakaden"; // Your Wifi password, in case you have open network comment the whole statement.
